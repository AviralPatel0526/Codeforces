...
import java.lang.*;
import java.io.*;
public class D_Index_A_Not_Continuous_ver {
    ...
    static long f(int i,int c,int m,long a[],long dp[][]){
        if(i == a.length){
            if(c == m+1){
                return 0;
            }else{
        ...
        long skip=f(i+1,c,m,a,dp);
        long pick=c*a[i] + f(i+1,c+1,m,a,dp);
    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        System.out.println(f(0,1,m,a,dp));
    }
}