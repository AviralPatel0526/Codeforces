...
public class E_Interesting_Ratio {
    ...
    static ArrayList<Integer> fillSieve(int ssize) {
    ...
    // Binary search: returns index of largest prime <= n.
    static int lb(int n, ArrayList<Integer> list) {
        int l = 0;
        int h = list.size() - 1;
        int ans = -1;
        while (l <= h) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<Integer> list = fillSieve(10000000);
        ...
        while (t-- > 0) {
            ...
            for (int i = 1; i <= n;) {
                int div = n / i;
                int hi = n / div;
                int numPrimes = lb(div, list) + 1; 
                ans += (long)(hi - i + 1) * numPrimes;
                i = hi + 1;
            }
            out.println(ans);
        }
