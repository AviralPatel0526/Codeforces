    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t != 0) {
            ...
            if(x == y) {System.out.println(-1);}
                ...
                String binaryStringx = String.format("%64s", Long.toBinaryString(x)).replace(' ', '0');
            String binaryStringy = String.format("%64s", Long.toBinaryString(y)).replace(' ', '0');
            String q="";
            outer:for(int i=63;i>=0;i--){
                if(binaryStringx.charAt(i) == '1' && binaryStringy.charAt(i) == '1'){
                    for(int j=i;j>=0;j--){
                        q+='1';
                        if(binaryStringx.charAt(j) != binaryStringy.charAt(j)){
                            break outer;
                        }
                    }
                }else{
            ...
            long number = new BigInteger(a, 2).longValue();
