        ...
        while (t != 0) {
            ...
            while(i < j){
                if(list.get(i) < list.get(j)){
                    ans+=-1*list.get(i)*list.get(i+1);
                    long add=list.get(i+2);
                    list.set(i+2,list.get(i)+add);
                    i+=2;
                }else{
                    ans+=-1*list.get(j)*list.get(j-1);
                    long add=list.get(j-2);
                    list.set(j-2,list.get(j)+add);
                    j-=2;
                }
            }
