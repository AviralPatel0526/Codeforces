    ...
    public static void main(String[] args) throws java.lang.Exception {
        ...
        while (t != 0) {
            ...
            for(int i=0;i<r1.length()-2;i++){
                char ch=r1.charAt(i);
                char ch1=r1.charAt(i+1);
                char ch2=r1.charAt(i+2);
                char ch3=r2.charAt(i);
                char ch4=r2.charAt(i+1);
                char ch5=r2.charAt(i+2);
                if(ch == 'x' && ch1 == '.' && ch2 == 'x'){
                    if(ch3 == '.' && ch3 == ch4 && ch4 == ch5){
                        cnt++;
                    }
                }
                else if(ch3 == 'x' && ch4 == '.' && ch5 == 'x'){
                    if(ch == '.' && ch == ch1 && ch1 == ch2){
                        cnt++;
                    }
                }
            }
